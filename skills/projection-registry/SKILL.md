...
3. **Execute Registered Projections**:
   ...
   - `upwork-proposal` (if `target_type: upwork`) ➔ `out/<target-slug>/upwork-qualification-report.md`, `out/<target-slug>/upwork-screening-answers.md`, `out/<target-slug>/upwork-work-samples.md`
